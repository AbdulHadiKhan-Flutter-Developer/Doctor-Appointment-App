...
class DoctorScreenDrawer extends StatefulWidget {
  const DoctorScreenDrawer({super.key});

  @override
  State<DoctorScreenDrawer> createState() => _DoctorScreenDrawerState();
}

class _DoctorScreenDrawerState extends State<DoctorScreenDrawer> {
  var selectedindex = 0;
    ...
    return Drawer(
      ...
      child: Wrap(
        ...
        children: [
          ...
          Column(
            children: [
              selecteditem(Icons.dashboard, 'Dashboard', () {}, 0),
              selecteditem(Icons.person, 'Profile', () {}, 1),
  ...
  Widget selecteditem(
      IconData icon, String title, VoidCallback ontap, int index) {
